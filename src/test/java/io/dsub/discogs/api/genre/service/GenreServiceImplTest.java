...
class GenreServiceImplTest extends ConcurrentTest {
    ...
    void findAllReturnsWithPage() {
        ...
        given(genreRepository.findAllByNameNotNullOrderByNameAsc(captor.capture())).willReturn(genreFlux);
        ...
        verify(genreRepository, times(1)).findAllByNameNotNullOrderByNameAsc(pageable);
    ...
    void findAllReturnsEmptyPage() {
        ...
        ArgumentCaptor<Pageable> captor = ArgumentCaptor.forClass(Pageable.class);
        given(genreRepository.findAllByNameNotNullOrderByNameAsc(captor.capture())).willReturn(emptyGenreFlux);
